...
export default function App() {
  return (
    <div className="container">
      ...
      <section className="slider-section">
        <h2>5. 썸네일 네비게이션 슬라이더(Thumbnail Naviation Slider)</h2>
        <ThumbnailSlider />
      </section>
      ...
      <section className="slider-section">
        <h2>7. 커스텀 네비게이션 슬라이더(Custom Nav Slider)</h2>
        <CustomNavSlider />
      </section>

      <section className="slider-section fontawesome-section">
        <h2>8. Font Awesome 화살표 슬라이더 (FontAwesome Arrows Slider)</h2>
        <FontAwesomeSlider />
      </section>

      <section className="slider-section fontawesome-section">
        <h2>9. 이미지 화살표 슬라이더 (Image Arrow Slider)</h2>
        <ImageArrowSlider />
      </section>
    </div>
  );
