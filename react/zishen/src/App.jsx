...
export default function App() {
  ...
  const handleMobileNavClick = (e) => {
    ...
    if (subMenu && subMenu.classList.contains("sub")) {
      const isDisplayed = subMenu.style.display === "block"; //isDisplayed -> false
      const allSubs = document.querySelectorAll(".mobile_nav .sub");
      allSubs.forEach((sub) => {
        sub.style.display = "none"; //  '='  1번 쓰면 none을 넣으라는 얘기
      });
      if (!isDisplayed) {
        //!(not)isDisplayed -> true
          ...
          <div className="items_grid">
            <div className="item_card">
              ...
              <div className="item_info">
                ...
                <p className="item_price">￦350,000</p>
